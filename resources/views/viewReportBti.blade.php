  ...
  <body>
    <page size="A4">
      ...
      <div class="item-bti-3">
        ...
        <textarea class="form-control form-control-3 " rows="3" required></textarea>
      </div>
      </div>
      <hr>
      <div class="item-all-bti-3">
      ...
      <div class="item-11bti">
        <div class="item-div-11bti">
          ...
          <img src="../image/signcustomer.png" alt="" style="height: 80px;">
        ...
        <div class="item-div-11bti">
          ...
          <img src="../image/signtechical.png" alt=""  style="height: 80px;">

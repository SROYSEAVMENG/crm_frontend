...
<body>
            ...
            <div class="menu">
                <ul class="menu-links">
                    ...
                    <div class="text" id="drop-container-1" style="padding-left: 60px; display: none;">
                        ...
                        <a href="service" class="link2 sub-list-active">Service</a>
                    </div>
    ...
    <section class="home" >
        ...
        <div style="float:right;" ><button class=" btn-create-new-service" ><i class='bx bxs-plus-circle'></i>&nbsp;&nbsp;SERVICE</button></div>
  ...
  <tr>
    ...
    <td>
        ...
        <i style="color: white;" class="fa fa-pencil fa-solid" aria-hidden="true"></i>
          ...
          <span>
          <button style="background-color: #F60E0E;border-radius:4px;" class="btn-crud-list-service btn-delete-service">
...
<!-- create atn -->
<div class="background-create-service">
<div class="content-create-new-service">
    ...
    <form action="#" class="signin-form">
        ...
        <div>
            <button class="btn-submit-service">SAVE</button>
        </div>
    </form>
...
<!-- end service -->            
<!------------- Form delete service ------------>
    <div class="background-delete-service">
    ...
    <script>
      ...
      modeText = body.querySelector(".mode-text");
        ...
        // end sidebar
        //start popup create
        let pop_up1111111 = document.querySelector(".background-create-service")
    let create_atm_button = document.querySelector(".btn-create-new-service")
    let close_create_atm = document.querySelector(".icon-cancel-new-service")

    create_atm_button.onclick = () => {
      pop_up1111111.style.display = "block"
      close_create_atm.onclick = () => pop_up1111111.style.display = "none"
    }

    let pop_up2222222 = document.querySelector(".background-delete-service")
    let btn_delete_service = document.querySelector(".btn-delete-service")

...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../css/createPM.css" />
...
<hr>
      ...
      <div class="item-11pm">
        <div class="item-div-11pm">
          ...
          <img src="../image/signcustomer.png" alt="" style="height: 100px;">
          <!-- <a href="drewCustomerPM">
          <button class="form-control form-control-btn" id="customer_signature">SIGN HERE</button>
          </a> -->
        </div>
        <div class="item-div-11pm">
          <label for="">Technician Signature</label>
          <img src="../image/signtechical.png" alt="" style="height: 100px;">
          <!-- <a href="drewTechnicalPM">

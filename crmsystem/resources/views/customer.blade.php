...
<body>
  ...
  <tr>
    ...
    <td>
        <span>
            <button class="btn-crud-list-customer" style="background-color: #423EFF; border-radius: 4px;">
...
<div class="content-create-new-customer-create">
    <div>
        <div class="a">
            <div class="name-new-new-customer-create" style="float:left;">NEW CUSTOMER</div>
    ...
    <form action="#" class="signin-form">
        <div class="form-group-new-customer-create" style="float:left; ">
            ...
            <input type="text" class="form-control-new-customer-create" placeholder="Name Company" required>
        </div>
        <div class="form-group-new-customer-create" style="float:right; ">
            <label class="label" for="email-company">Email</label>
            <input type="email" class="form-control-new-customer-create" placeholder="Email Company" required>
        </div>
        <div class="form-group-new-customer-create" style="float:left;">
            <label class="label" for="phone-number-company">Phone Number</label>
            <input type="number" class="form-control-new-customer-create" placeholder="Phone Number" required>
        </div>
        <div class="form-group-new-customer-create" style="float:right;">
            <label class="label" for="address-company">Address</label>
            <input type="text" class="form-control-new-customer-create" placeholder="Address" required>
        </div>
        <div class="form-group-new-customer-create" style="float:left;">
            <label class="label" for="city-company">City</label>
            <input type="text" class="form-control-new-customer-create" placeholder="City" required>
        </div>
        <div class="form-group-new-customer-create" style="float:right;">
            <label class="label" for="service">Service</label>
            <input type="text" class="form-control-new-customer-create" placeholder="service" required>
        </div>
        <div class="form-group-new-customer-create" style="float:left;">
            <label class="label" for="designation-company">Designation</label>
            <input type="text" class="form-control-new-customer-create" placeholder="Designation" required>
        </div>
        ...
        <div class="form-group-new-customer-create" style="float:left; width: 50%;">
            ...
            <select name="input-by" class="form-control-new-customer-create">
              <option value=""></option>
        ...
        <div class="form-group-new-customer-create" style="width: 100%; " >
            ...
            <input type="text" class="form-control-new-customer-create" placeholder="Description" required>
        </div>
        <div class="form-group-new-customer-create" style="padding: 20px 0px 0px 335px;" >
            <button class="btn-create-new-customer-create">SUBMIT</button>
        </div>
...
<!-- end of create customer -->
    ...
    <script>
      ...
      modeText = body.querySelector(".mode-text");
        ...
        // end sidebar
        let pop_up111 = document.querySelector(".content-create-new-customer-create")
    ...
    let pop_up222 = document.querySelector(".delete-dev-customer")

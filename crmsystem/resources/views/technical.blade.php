...
<body>
            ...
            <div class="all">
                ...
                <div class="container-conReport2" style="float: right;">
                    ...
                    <div class="under2">
                        ...
                        <div style="float: right;">
                            <button class="btn-create-bti">LIST REPORT</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    //     });
        // end sidebar
    //    start next page list report
            var button = document.getElementById("btn-list-rep-pm");

            // Add click event listener to the button
            button.addEventListener("click", function() {
                // Change the page URL
                window.location.href = "/"; // Replace "newpage.html" with the desired destination URL
            });

            var button = document.getElementById("technician-signature");

            // Add click event listener to the button
            button.addEventListener("click", function() {
                // Change the page URL
                window.location.href = "drew.html"; // Replace "newpage.html" with the desired destination URL
            });
    //    end next page list report

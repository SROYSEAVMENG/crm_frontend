            ...
            <div class="container-fluid">    
                <table>
                    ...
                    <tr>
                      ...
                      <td>
                          <span>
                              <button class="btn-crud-list-lead" style="background-color: #423EFF; border-radius: 4px;">
...
<div class="content-create-new-lead-create">
    ...
    <form action="#" class="signin-form">
        <div class="form-group-new-lead-create" style="float:left; ">
            ...
            <input type="text" class="form-control-new-lead-create" placeholder="Name Company" required>
        </div>
        <div class="form-group-new-lead-create" style="float:right; ">
            <label class="label" for="email-company">Email</label>
            <input type="email" class="form-control-new-lead-create" placeholder="Email Company" required>
        </div>
        <div class="form-group-new-lead-create" style="float:left;">
            <label class="label" for="phone-number-company">Phone Number</label>
            <input type="number" class="form-control-new-lead-create" placeholder="Phone Number" required>
        </div>
        <div class="form-group-new-lead-create" style="float:right;">
            <label class="label" for="address-company">Address</label>
            <input type="text" class="form-control-new-lead-create" placeholder="Address" required>
        </div>
        <div class="form-group-new-lead-create" style="float:left;">
            <label class="label" for="city-company">City</label>
            <input type="text" class="form-control-new-lead-create" placeholder="City" required>
        </div>
        <div class="form-group-new-lead-create" style="float:right;">
            <label class="label" for="service">Service</label>
            <input type="text" class="form-control-new-lead-create" placeholder="service" required>
        </div>
        <div class="form-group-new-lead-create" style="float:left;">
            <label class="label" for="designation-company">Designation</label>
            <input type="text" class="form-control-new-lead-create" placeholder="Designation" required>
        </div>
        ...
        <div class="form-group-new-lead-create" style="width: 100%; " >
            ...
            <input type="text" class="form-control-new-lead-create" placeholder="Description" required>
        </div>
        <div class="form-group-new-lead-create" style="padding: 20px 0px 0px 335px;" >
            <button class="btn-create-new-lead-create">SUBMIT</button>
        </div>
...
modeSwitch.addEventListener("click" , () =>{
    ...
    if(body.classList.contains("dark")){
        ...
        // end sidebar
        let pop_up11 = document.querySelector(".content-create-new-lead-create")
    ...
    let pop_up22 = document.querySelector(".delete-dev-lead")
